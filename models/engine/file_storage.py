#!/usr/bin/python3
"""
A module serializing instances to JSON file
...
class FileStorage:
    """
    instance is for storing and retrieving JSON strings
    """
    ...
    def all(self):
        """
        method that returns a dictionary of all objects stored in
    ...
    def new(self, obj):
        """
        An instance method seting the '__objects' with the obj argument
        """
    ...
    def save(self):
        """
        serializes the objects to the json file in given path
        """
    ...
    def reload(self):
        """
        Retrieves the JSON file to '__objects' attribute
        """
